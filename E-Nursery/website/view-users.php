                    ...
                    <tbody>
                      ...
                      ?>
                        <tr style="border: 1px solid #f2f2f2">
                            ...
                            <td><?php echo $p_res['fname']." ".$p_res['lname']; ?></td>
                            <td><?php echo $p_res['email']; ?></td>
                            <td><?php echo $p_res['address']; ?></td>
                            <td>$ <?php echo $p_res['tsale']; ?></td>
                            <td class="td-actions text-right">
                                <a href="update-user.php?id=<?php echo $p_res['id']; ?>" ><button type="button" rel="tooltip" class="btn btn-light btn-just-icon btn-sm" data-original-title="" title="">
                                    <i class="material-icons"><i class="fa fa-pencil" style="color: grey"></i></i>
                                </button></a>
                                <a href="./scripts/delete-user-script.php?id=<?php echo $p_res['id']; ?>" ><button onclick="return confirm('Are want to Delete This User?')" type="button" rel="tooltip" class="btn btn-light btn-just-icon btn-sm deletebtn" >
